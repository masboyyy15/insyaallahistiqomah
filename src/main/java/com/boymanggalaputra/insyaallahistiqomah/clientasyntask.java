...
public class clientasyntask extends AsyncTask<Void, Void, String> {
    ...
    public clientasyntask(Context mContext, String api_url, OnPostExecuteListener mPostExecuteListener){
