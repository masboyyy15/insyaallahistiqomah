...
public class ClientAsyncTask2 extends AsyncTask<Void, Void, String> {
    ...
    public ClientAsyncTask2(Context mContext, String api_url, OnPostExecuteListener mPostExecuteListener){
